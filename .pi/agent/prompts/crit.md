...
argument-hint: "[file, PR, or commit range]"
---
...
4. Reply with what you did: `crit comment --reply-to <id> --author 'Pi' '<what you did>'` (works for both file IDs `c_…` and review IDs `r_…`; reply bodies support markdown)
