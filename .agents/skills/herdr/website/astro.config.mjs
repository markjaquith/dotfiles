...
const nonCanonicalDocsPath =
	/^\/(?:ja\/|zh-cn\/)?docs\/(?:preview|\d+\.\d+\.\d+)(?:\/|$)/
			...
			sidebar: [
				{
					...
					items: [
						{
							label: "Overview",
							translations: { ja: "概要", "zh-CN": "概览" },
							slug: "docs",
						},
						{
							label: "Install",
							translations: { ja: "インストール", "zh-CN": "安装" },
							slug: "docs/install",
						},
						{
							label: "Quick start",
							translations: { ja: "クイックスタート", "zh-CN": "快速开始" },
							slug: "docs/quick-start",
						},
						{
							label: "Concepts",
							translations: { ja: "コンセプト", "zh-CN": "核心概念" },
							slug: "docs/concepts",
						},
						{
							label: "Keyboard",
							translations: { ja: "キーボード", "zh-CN": "键盘" },
							slug: "docs/keyboard",
						},
					],
				},
				{
					...
					items: [
						{
							label: "How to work with Herdr",
							translations: {
								ja: "Herdr での作業の進め方",
								"zh-CN": "使用 Herdr 的工作方式",
							},
							slug: "docs/how-to-work",
						},
						{
							label: "Agents",
							translations: { ja: "エージェント", "zh-CN": "智能体" },
							slug: "docs/agents",
						},
						{
							...
							slug: "docs/agent-automation",
						},
						{
							label: "Session state and restore",
							translations: {
								ja: "セッション状態と復元",
								"zh-CN": "会话状态与恢复",
							},
							slug: "docs/session-state",
						},
						{
							label: "Persistence and remote access",
							translations: {
								ja: "永続化とリモートアクセス",
								"zh-CN": "持久化与远程访问",
							},
							slug: "docs/persistence-remote",
						},
					],
				},
				{
					...
					items: [
						{
							label: "Configuration",
							translations: { ja: "設定", "zh-CN": "配置指南" },
							slug: "docs/configuration",
						},
						{
							label: "Config reference",
							translations: { ja: "設定リファレンス", "zh-CN": "配置参考" },
							slug: "docs/config-reference",
						},
						{
							label: "Plugins",
						...
						{
							label: "Marketplace",
							translations: { ja: "マーケットプレイス", "zh-CN": "插件市场" },
				...
				},
				{
					...
					items: [
						{
							label: "CLI reference",
							translations: { ja: "CLI リファレンス", "zh-CN": "CLI 参考" },
							slug: "docs/cli-reference",
						},
						{
							label: "Socket API",
							translations: { ja: "ソケット API", "zh-CN": "Socket API" },
							slug: "docs/socket-api",
						},
						{
							label: "Integrations",
							translations: { ja: "インテグレーション", "zh-CN": "集成" },
						...
						{
							label: "Windows beta",
							translations: { ja: "Windows ベータ", "zh-CN": "Windows 测试版" },
							slug: "docs/windows-beta",
						},
					],
				},
				{
					...
					items: [
						...
						{
							label: "Next docs",
							translations: { ja: "次期版ドキュメント", "zh-CN": "下一版文档" },
							slug: "docs/preview",
						},
					],
				},
