...
const scopes = {
	...
	preview: {
		locales: { root: ["", "install", "new-page"], ja: ["", "install"] },
	},
...
describe("docsRoute", () => {
	test.each([
		...
		[
			"/ja/docs/install/",
			{ isDocs: true, locale: "ja", target: "stable", page: "install" },
		],
		[
			"/docs/preview/new-page/",
			{ isDocs: true, locale: undefined, target: "preview", page: "new-page" },
		],
		[
			"/zh-cn/docs/preview/",
			{ isDocs: true, locale: "zh-cn", target: "preview", page: "" },
		],
		[
			"/docs/0.7.4/install/",
			{ isDocs: true, locale: undefined, target: "0.7.4", page: "install" },
		],
		[
			"/ja/docs/0.7.4/",
			{ isDocs: true, locale: "ja", target: "0.7.4", page: "" },
		],
		[
			"/blog/",
			{ isDocs: false, locale: undefined, target: "stable", page: "" },
		],
